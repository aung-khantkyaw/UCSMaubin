...
namespace Withdraw_Deposit
{
    public partial class LoginAndRegistration : Form
    {
        ...
        private void LoginAndRegistration_Load(object sender, EventArgs e)
        {
            ...
            SqlConnection con1 = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\DELL\Documents\Account.mdf;Integrated Security=True;Connect Timeout=30");
            con1.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\DELL\Documents\Account.mdf;Integrated Security=True;Connect Timeout=30");
                    con.Open();
