...
const String _url = 'http://103.47.184.69:81/post-categories/80';
...
class PostCowPage1 extends StatelessWidget {
  const PostCowPage1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("နွားများတွင်ဖြစ်တတ်သောရောဂါများ"),
