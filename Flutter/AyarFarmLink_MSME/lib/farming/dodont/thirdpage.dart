...
import 'package:chatapp_firebase/farming/dodont//third_item_description.dart';
import 'package:chatapp_firebase/farming/dodont/thirditem.dart';
  ...
  Widget renderGridItem(Item item){
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => ThirdItemDescription(item: item)),
        );
      },
      child: Container(
        decoration: BoxDecoration(
