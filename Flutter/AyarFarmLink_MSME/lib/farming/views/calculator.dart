                        ...
                        children: [
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xffd5d2d2),
                          ...
                          ElevatedButton(
                            ...
                            child: const Icon(Icons.backspace_outlined,color: Color(0xff0762ea)),
                          ),
                          ElevatedButton(
                            onPressed: () {
                              operator = '%';
                        ...
                        children: [
                          ElevatedButton(
                            onPressed: () {Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => MyHomePage2(title: 'တွက်ချက်ရန်',)),
                            );
                            setState(() {
                              enteredText = '';
                            });
