...
import 'package:chatapp_firebase/farming/price//bean1.dart';
import 'package:chatapp_firebase/farming/price//main.dart';
import 'package:url_launcher/url_launcher.dart';

const String _url = 'http://103.47.184.69:81/post-categories/213';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("ပဲစျေးနှုန်းများ‌‌"),
